...
const Login = () => {
  ...
  return (
    <div className="min-h-screen bg-primary-50 dark:bg-dark-900 flex items-center justify-center p-4 transition-colors">
      <div className="bg-white/90 dark:bg-dark-800/90 backdrop-blur-xl p-8 rounded-[32px] shadow-2xl w-full max-w-md border border-white/50 dark:border-dark-700">
        <div className="flex flex-col items-center mb-10">
          ...
          <p className="text-gray-500 dark:text-dark-400 mt-2 font-medium">Sign in to connect & vibe</p>
        </div>

        {error && <div className="bg-red-50 text-red-500 p-3 rounded-xl mb-6 text-sm text-center font-bold border border-red-100">{error}</div>}
        ...
        <p className="text-center text-gray-500 dark:text-dark-400 mt-8 text-sm">
          Don't have an account? <Link to="/register" className="text-primary-500 font-bold hover:underline">Sign up</Link>
        </p>
      </div>
    </div>
